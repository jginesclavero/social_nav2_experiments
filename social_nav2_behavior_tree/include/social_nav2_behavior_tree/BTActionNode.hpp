...
#ifndef social_nav2_behavior_tree__BTACTIONNODE_HPP_
#define social_nav2_behavior_tree__BTACTIONNODE_HPP_
...
public:
  ...
  void halt() override
  {
    if (should_cancel_goal()) {
      ...
      RCLCPP_INFO(node_->get_logger(), "Current goal cancelled for %s", action_name_.c_str());
    }
...
protected:
  ...
  void on_new_goal_received()
  {
    ...
    RCLCPP_INFO(node_->get_logger(), "New goal sended");
...
#endif  // social_nav2_behavior_tree__BTACTIONNODE_HPP_
